...
public class Apartment3 implements Screen {
    TiledMap tiledMap;
    ...
    public void show() {
            ...
            tiledMap = new TmxMapLoader().load("Apartment_3.tmx");
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isKeyPressed(Input.Keys.B)){
          gameReference.setScreen(new Bathroom3(gameReference));
       }
        batch.end();
    }
