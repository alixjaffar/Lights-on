...
/**
 * @Author: Nazeem Naik
 * @Description: Bathroom location, leading from apartment #2
 */

public class Bathroom2 implements Screen {
    TiledMap tiledMap;
    ...
    public void show() {
            ...
            tiledMap = new TmxMapLoader().load("Bathroom_Standard.tmx");
