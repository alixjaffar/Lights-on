...
/**
 * @Author: Nazeem Naik
 * @Description: Bathroom location, leading from apartment #4
 */

public class Bathroom4 implements Screen {
    TiledMap tiledMap;
    ...
    public void render(float delta) {
        ...
        font.draw(batch, "WRITE", 150, 400);
        font.draw(batch, "ALI", 250, 300);
        batch.end();
        batch.begin();
        font = new BitmapFont();
        ...
        if (Gdx.input.isKeyPressed(Input.Keys.LEFT & Input.Keys.RIGHT)) {
          gameReference.setScreen(new Apartment4(gameReference));
