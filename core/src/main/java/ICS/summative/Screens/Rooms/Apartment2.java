...
/**
 * @Author: Ali Jaffar
 * @Description: This is the second apartment screen
 */

public class Apartment2 implements Screen {
    TiledMap tiledMap;
    ...
    public void show() {
            ...
            tiledMap = new TmxMapLoader().load("Apartment_2.tmx");
    ...
    public void render(float delta) {
       ...
       if (Gdx.input.isKeyPressed(Input.Keys.B)){
          gameReference.setScreen(new Bathroom2(gameReference));
       }
        batch.end();
    }
