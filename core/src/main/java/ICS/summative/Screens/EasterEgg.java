...
/**
 * @Author: Ali Jaffar
 * @Description: This is the EasterEgg class. It is a screen that is accessed by the player when a certian key input is used
 */
...
public class EasterEgg implements Screen {
 ...
 public void camera() {
    ...
    public void show() {
         ...
         // get the tmx file
         TiledMap tiledMap = new TmxMapLoader().load("Easter_Egg.tmx");
        ...
        player.draw(batch);
            ...
            batch.begin();
               font = new BitmapFont();
                ...
                font.draw(batch, "You found the Easter Egg! Click Q to go back", 180, 100);
